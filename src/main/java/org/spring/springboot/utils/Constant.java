...
public class Constant {
    ...
    public static final String BASE_URL = DuckPorperties.getKey(DuckPorperties.TelecomType.TELECOMBASEURL);

    public static final String CALLBACK_BASE_URL = DuckPorperties.getKey(DuckPorperties.TelecomType.SUBSCRIBECALLBACK);

    public static final String APPID = DuckPorperties.getKey(DuckPorperties.TelecomType.APPID);

    public static final String SECRET = DuckPorperties.getKey(DuckPorperties.TelecomType.SECRET);
...
//            + "/na/iocm/devNotify/v1.1.0/reportCmdExecResult";
    ...
    public static final String CREATE_RULES_CMD = BASE_URL + "/iocm/app/rule/v1.2.0/rules";
